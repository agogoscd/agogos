...
A Component build trigger can be used to trigger a resource after a build of a specific Component is finished and we know exactly what is the Component name.
