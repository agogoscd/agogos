...
Successful _Build_ triggers are defined inside of the `build` section in the
_Component_ resource.
...
a _Component_ belongs to. Finally, we can utilize link:https://github.com/google/cel-spec/blob/master/doc/langdef.md[CEL expressions]
