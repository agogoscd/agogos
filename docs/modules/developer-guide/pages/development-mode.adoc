...
----
QUARKUS_HTTP_SSL_CERTIFICATE_FILE="$(pwd)/webhooks.crt" \
QUARKUS_HTTP_SSL_CERTIFICATE_KEY_FILE="$(pwd)/key.pem" \
./mvnw quarkus:dev -pl webhooks -am -Dquarkus.http.host=0.0.0.0
----
